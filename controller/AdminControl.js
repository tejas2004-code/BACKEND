...
const addProduct = async (req, res) => {
    const { name, brand, price, category, image,  type, author, description, gender } = req.body;
    try {
        await Product.create({ name, brand, price, category, image,type, author, description, gender })
        success = true
        res.send(success)
